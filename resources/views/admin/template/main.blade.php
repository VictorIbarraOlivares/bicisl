...
<script src="{{ asset('plugins/datatables/Buttons-1.2.4/js/buttons.html5.min.js') }}"></script>
<script src="{{ asset('plugins/datatables/Buttons-1.2.4/js/jszip.min.js') }}"></script>
<!-- FIN DATATABLES -->
<!-- Para autocompletar -->
