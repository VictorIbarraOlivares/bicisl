			...
			<div class="modal-header">
				...
				<h4 class="modal-title center-block" style="color: #ED1723;"><strong > ¡ ATENCIÓN !</strong></h4>
	                    ...
	                    <div class="modal-body">
	                        <div class="form-group">
	                            <div class="col-md-12">
	                                <div class="form-group">
	                                <center>
									<p><strong>¿Seguro quiere eliminar este usuario?</strong></p>
									<p style="color: #080266;"><strong>{{ $user->name }}</strong></p>
									<br>
									<p>Toda la información del usuario se borrará</p>
									<p style="color: #ED1723;"><strong> No se podrá recuperar</strong></p>
									</center>
									</div>
	                            </div>
	                        </div>
	                ...
	                <div class="modal-footer">
	                    ...
	                    <a href="{{ route('admin.users.destroy', $user->id) }}" class="btn btn-danger" title="Eliminar"><i class="fa fa-trash fa-2x"  aria-hidden="true" style="color:black;" title="Eliminar"></i>&nbsp; Eliminar</a>
	                </div>
