			...
			<div class="modal-header">
				...
				<h4 class="modal-title center-block" style="color: #ED1723;"><strong > ¡ ATENCIÓN !</strong></h4>
	                ...
	                <div class="modal-footer">
	                    <button class="btn btn-warning pull-left" title="Volver" data-dismiss="modal" aria-hidden="true"><i class="fa fa-reply" aria-hidden="true"></i>&nbsp; Volver</button>
	                    <a href="{{ route('admin.bicicletas.cambiar', $bike->id) }}" class="btn btn-danger" title="Retirar"><i class="fa fa-bicycle fa-lg"  aria-hidden="true" style="color:black;" title="Retirar"></i>&nbsp; Retirar</a>
	                </div>
