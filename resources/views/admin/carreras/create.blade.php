		...
		<div class="row">
			<div class="col-md-5 ">
				<div class="form-group form-inline">
					...
					{!! Form::text('nombre', null ,['class' => 'form-control letras', 'placeholder' => 'Ingrese nombre de la carrera' ,'required','style' => 'width: 90%' , 'onkeyup' => 'validaNombre();']) !!}
		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group form-inline">
					...
					{!! Form::number('codigo_carrera', null ,['class' => 'form-control numeros', 'placeholder' => 'Ingrese código de la carrera' ,'required' ,'style' => 'width:90%' , 'onkeyup' => 'validaCodigo();']) !!}
