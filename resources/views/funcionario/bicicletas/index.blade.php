		...
		<tbody>
			@foreach($bikes as $bike)
				<tr>
					...
					<td>
						<a href="{{ route('funcionario.bicicletas.edit', $bike->id) }}" class="btn btn-warning" title="Editar"><span class="glyphicon glyphicon-pencil" aria-hidden="true" title="Editar"></span></a>
					</td>
				</tr>
			@endforeach
		</tbody>
