			...
			<div class="modal-header">
				...
				<h4 class="modal-title center-block" style="color: #ED1723;"><strong > ¡ ATENCIÓN !</strong></h4>
	                ...
	                <div class="modal-footer">
	                    ...
	                    <a href="{{ route('funcionario.bicicletas.edit', $bike->id) }}" class="btn btn-danger" title="Editar"><i class="fa fa-pencil fa-2x"  aria-hidden="true" style="color:black;" title="Editar"></i>&nbsp; Editar</a>
	                </div>
			</div>
		</div>
	</div>
