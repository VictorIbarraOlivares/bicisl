  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" align="center">
      <ul class="nav navbar-nav">
        <li><a href="{{route('funcionario.users.index') }}">Listado de Usuarios</a></li>
        <li><a href="{{ route('funcionario.carreras.index') }}">Listado de Carreras</a></li>
        <li><a href="{{ route('funcionario.bicicletas.index') }}">Listado de Bicicletas</a></li>
        <li class="dropdown">
