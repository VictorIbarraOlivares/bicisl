              ...
              @else
                  <li class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu">
                          <li><a href="{{ route('funcionario.users.detalle', Auth::user()->id) }}" style="font-size:16px;color: #080266;" title="Ver Perfil">
                          <span class="glyphicon glyphicon-eye-open " style="color: #00956F" aria-hidden="true" title="Ver Perfil"></span>   Ver Perfil</a></li>
                          <li><a href="{{ route('funcionario.users.edit', Auth::user()->id) }}" style="font-size: 16px;color: #080266;" title="Editar Perfil">
                            <span class="glyphicon glyphicon-pencil" aria-hidden="true" style="color: #080266" title="Editar Perfil"></span>   Editar Perfil</a></li>
                          <li>
                              <a href="{{ route('funcionario.users.password', Auth::user()->id ) }}" style="font-size: 16px;color: #080266;" title="Editar Perfil"><span class="glyphicon glyphicon-pencil" aria-hidden="true" style="color: #080266" title="Editar Password"></span>   Editar Password</a>
                          </li>
                          <li role="separator" class="divider"></li>
