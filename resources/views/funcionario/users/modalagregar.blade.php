			...
			<div class="modal-header">
				...
				<h4 class="modal-title center-block"><strong >Nueva Bicicleta</strong></h4>
	                ...
	                <div class="modal-footer">
	                    ...
	                    <a href="{{ route('funcionario.bicicletas.create', $user->id) }}" class="btn btn-danger" title="Agregar"><i class="fa fa-bicycle fa-2x"  aria-hidden="true" style="color:black;" title="Agregar"></i>&nbsp; Agregar</a>
	                </div>
